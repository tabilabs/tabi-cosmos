...
func (s *decCoinTestSuite) TestParseDecCoins() {
	testCases := []struct {
		...
		{"", nil, false},
		{"4atabi", sdk.DecCoins{sdk.NewDecCoinFromDec("atabi", sdk.NewDecFromInt(sdk.NewInt(4)))}, false},
		{"5.5atom,4atabi", sdk.DecCoins{
			sdk.NewDecCoinFromDec("atom", sdk.NewDecWithPrec(5500000000000000000, sdk.Precision)),
			sdk.NewDecCoinFromDec("atabi", sdk.NewDec(4)),
		}, false},
		{"0.0atabi", sdk.DecCoins{}, false}, // remove zero coins
		{"10.0btc,1.0atom,20.0btc", nil, true},
		{
			"0.004atabi",
			sdk.DecCoins{sdk.NewDecCoinFromDec("atabi", sdk.NewDecWithPrec(4000000000000000, sdk.Precision))},
			false,
		},
		{
			"0.004atabi",
		...
		},
		{
			...
			sdk.DecCoins{
				...
				sdk.NewDecCoinFromDec("atabi", sdk.NewDecWithPrec(4000000000000000, sdk.Precision)),
			},
			false,
		},
		{"0.0atabi,0.004atabi,5.04atom", // remove zero coins
			sdk.DecCoins{
				sdk.NewDecCoinFromDec("atom", sdk.NewDecWithPrec(5040000000000000000, sdk.Precision)),
				sdk.NewDecCoinFromDec("atabi", sdk.NewDecWithPrec(4000000000000000, sdk.Precision)),
			},
...
func (s *decCoinTestSuite) TestDecCoinsString() {
	testCases := []struct {
		...
		{sdk.DecCoins{}, ""},
		{
			...
			"5.040000000000000000atom,0.004000000000000000atabi",
		},
	}
...
func (s *decCoinTestSuite) TestDecCoinsIntersect() {
	testCases := []struct {
		...
		{"", "", ""},
		{"1.0atabi", "", ""},
		{"1.0atabi", "1.0atabi", "1.0atabi"},
		{"", "1.0atabi", ""},
		{"1.0atabi", "", ""},
		{"2.0atabi,1.0trope", "1.9atabi", "1.9atabi"},
		{"2.0atabi,1.0trope", "2.1atabi", "2.0atabi"},
		{"2.0atabi,1.0trope", "0.9trope", "0.9trope"},
		{"2.0atabi,1.0trope", "1.9atabi,0.9trope", "1.9atabi,0.9trope"},
		{"2.0atabi,1.0trope", "1.9atabi,0.9trope,20.0other", "1.9atabi,0.9trope"},
		{"2.0atabi,1.0trope", "1.0other", ""},
		{"2.0atabi,1.0trope", "0.9trope,20.0other,1.9atabi", "1.9atabi,0.9trope"},
	}
