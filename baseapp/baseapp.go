...
import (
	...
	sdbm "github.com/tabilabs/tabi-tm-db/backends"
...
func NewBaseApp(
	...
	if app.ChainID == "" {
		panic("must pass --chain-id when calling 'tabid start' or set in ~/.tabi/config/client.toml")
	}
	...
	for i, msg := range msgs {
		...
		if handler := app.msgServiceRouter.Handler(msg); handler != nil {
			...
			metrics.MeasureSinceWithLabels(
				[]string{"tabi", "cosmos", "run", "msg", "latency"},
				startTime,
