...
// If expedited, the deposit to enter voting period will be increased to 5000 atabi.
...
var (
	MinExpeditedDeposit   = sdk.NewCoins(sdk.NewCoin("atabi", types.DefaultMinExpeditedDepositTokens))
