...
import (
	...
	commonerrors "github.com/facjas/tabi-db/common/errors"
	"github.com/facjas/tabi-db/config"
	"github.com/facjas/tabi-db/proto"
	"github.com/facjas/tabi-db/sc"
	sctypes "github.com/facjas/tabi-db/sc/types"
	"github.com/facjas/tabi-db/ss"
	"github.com/facjas/tabi-db/ss/pruning"
	sstypes "github.com/facjas/tabi-db/ss/types"
...
// ListeningEnabled will always return false for tabidB
func (rs *Store) ListeningEnabled(_ types.StoreKey) bool {
	return false
}

// AddListeners is no-opts for tabidB
